# Automatic Attendance system using Face Recognition | Abhishek Wahane
...
image_2 = face_recognition.load_image_file("students/2.jpeg")
...
image_5 = face_recognition.load_image_file("students/5.jpeg")
...
while True:
 # Grab a single frame of video
    ...
    book.save('att_month_' + str(month) + '.xlsx')
